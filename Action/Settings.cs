...
namespace PostMediumGitHubAction
{
    ...
    { 
        ...
        [Option('a', "tags", Required = true, HelpText = "The post’s tags.")]
        public IEnumerable<string> Tags { get; set; }

        [Option('c', "canonical-url", Required = false, HelpText = "The canonical URL of the post. " +
        ...
        [Option('t', "integration-token", Required = false, HelpText = "The token that should be used to authenticate in the API." +
